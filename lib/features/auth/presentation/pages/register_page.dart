...
class _RegisterViewState extends State<_RegisterView> {
  ...
  Future<void> _submit(RegisterProvider ctrl) async {
    ...
    if (ctrl.status == RegisterStatus.success) {
      HapticFeedback.mediumImpact();
      widget.onRegisterSuccess(context);
    } else if (ctrl.status == RegisterStatus.failure) {
            ...
            child: Column(
              ...
              children: [
                ...
                Consumer<RegisterProvider>(
                  builder: (context, ctrl, _) => _RegisterCard(
                    formKey:      _formKey,
...
class _RegisterCard extends StatelessWidget {
  ...
  final RegisterProvider        controller;
